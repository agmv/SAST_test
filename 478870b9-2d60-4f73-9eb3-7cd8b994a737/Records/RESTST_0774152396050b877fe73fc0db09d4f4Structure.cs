...
public static ST_0774152396050b877fe73fc0db09d4f4Structure ToStructure(ssSystem_.RestRecords.RESTST_0774152396050b877fe73fc0db09d4f4Structure obj) { 
...
public static Func<ST_0774152396050b877fe73fc0db09d4f4Structure, ssSystem_.RestRecords.RESTST_0774152396050b877fe73fc0db09d4f4Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_0774152396050b877fe73fc0db09d4f4Structure s) => FromStructure(s, config);
}
public static ssSystem_.RestRecords.RESTST_0774152396050b877fe73fc0db09d4f4Structure FromStructure(ST_0774152396050b877fe73fc0db09d4f4Structure s, IBehaviorsConfiguration config) { 
  return new ssSystem_.RestRecords.RESTST_0774152396050b877fe73fc0db09d4f4Structure(s, config);
}
